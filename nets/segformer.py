...
from nets.utils import inverted_residual, make_divisible
...
from mmengine.model import (constant_init, normal_init, trunc_normal_init, BaseModule,
...
from nets.utils import PatchEmbed, nchw_to_nlc, nlc_to_nchw
...
class se(nn.Module):
    def __init__(self, num_classes=21, input_size=[512, 512]):
        ...
        self.backbone = MixVisionTransformer(
            ...
            attn_drop_rate=0.0,
            drop_path_rate=0.1)
        self.decode_head = SegformerHead(in_channels=[32, 64, 160, 256],
            in_index=[0, 1, 2, 3],
            channels=256,
            dropout_ratio=0.1,
            ...
            align_corners=False)
        self.upsample1 = nn.ConvTranspose2d(in_channels=self.num_classes, out_channels=self.num_classes, kernel_size=3, stride=2, padding=1,
                                            output_padding=1)
    def forward(self, inputs):
